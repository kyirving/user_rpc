...
func (c *userClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*EmptyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResp)
...
func (UnimplementedUserServer) Register(context.Context, *RegisterReq) (*EmptyResp, error) {
